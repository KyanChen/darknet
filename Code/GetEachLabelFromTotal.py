...
# 更改路径
txt_file = '/Users/keyanchen/OneDrive/工作/开课吧/无人机课程/第二节/实验/darknet/results/comp4_det_test_balloon.txt'
writer_path_label = os.path.abspath(os.path.join(txt_file, '..', 'label'))
classes = ['balloon']
class_to_write = 0
