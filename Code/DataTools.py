...
classes = ["human", "street light", "car", "fire hydrant", "street sign"]
img_path = "data/kaikeba_drone/data4YOLO"
xml_path = "data/kaikeba_drone/data4YOLO/labeled"
net_size = (416, 416)
img_format = 'jpg'
...
def resize_img(img_path):
    ...
    img_resize_path = os.path.join(img_path, 'resized_img')
...
def pair_img_txt():
    img_list = glob.glob(os.path.join(img_path, 'resized_img', '*.%s' % img_format))
